...
from ZPConvNets import Dataloader_3dmatch
...
class Trainer(vgtk.Trainer):
    ...
    def _setup_metric(self):
        ...
        anchors = torch.from_numpy(L.get_anchors()).to(self.opt.device)
    ...
    def _optimize(self, data):
        ...
        in_tensors = torch.cat([in_tensor_src.unsqueeze(1),in_tensor_tgt.unsqueeze(1)], 1)
    ...
    def eval(self):
        ...
        #     # np.savetxt('error.txt',all_error)
        #     # import ipdb; ipdb.set_trace()
